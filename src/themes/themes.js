    ...
    opulent: {
        ...
        colors: {
            ...
            navbar: {
                ...
                active_icon_bg: "rgb(34, 34, 52)", // Bleu-gris foncé pour l'icône active
                icons_bg: "rgb(17, 17, 38)", // Fond d'icônes sombre
                background: "rgb(12, 12, 32)", // Bleu nuit pour la navbar
                border: "rgb(23, 23, 41)", // Bordure discrète
            },
            border: "rgb(92, 113, 250)", // Bleu pour les bordures générales
        },
        fonts: {
